 ...
 * 
 */
public class serverplus extends Server
{
    private int i, ClientPortSpeicher, zwischenSpeicher2,x,y;
    private String ip, ClientIpSpeicher, entschlusseltText,zwischenSpeicher1,rt;
    ...
    private long berechne,k ;
    private int oSchlusselExpo, oSchlusselMod;
    public serverplus(int port)
    {
        super(port);

        win = new Fenster(400,400);
        feld = new BeschriftungsFeld("User 2 Chatmodul",30,30,300,40);
        ...
        //Öffentlicher Schlüssel von User 1 bzw Client
        oSchlusselExpo = 5;
        oSchlusselMod = 221;
        
        //Privater Schlüssel von User 2 bzw Server
        bigexponent = new BigInteger("63");
        bigmodulo = new BigInteger("253");
        
        if(super.isOpen()){
            //Bestätigung dass der Server  bereit ist
            System.out.println("-Neue Sitzung--> ");
            System.out.println("---User 2 erstellt---");
        }
        this.handling();
    }

    public void handling(){
        //Verwaltet alle Methoden
        while(!schließen.wurdeGedrueckt()){
            ...
            if(senden.wurdeGedrueckt()){
                ...
                //Senden von der Nachricht und Aurufen der Verschlüsselung
                //ClientIP und ClientPort wurden bei ProcessNewConnection gespeichert
                super.send(ClientIpSpeicher,ClientPortSpeicher,this.verschlusselung(text.text()));
                System.out.println("User 2 (Du): "+text.text());
                text.setzeText(" ");
            }
        }
            Hilfe.kurzePause();
    ...
    public  void processNewConnection(String pClientIP, int pClientPort){
        ...
        //Speichern des ClientIP und Clientport für das senden
        
        ClientIpSpeicher = pClientIP;
        ClientPortSpeicher = pClientPort;
    }

    public void processMessage(String pClientIP, int pClientPort, String pMessage){
        //Ausgabe der Nachricht und Aufruf von Decodieren
        System.out.println("User 1 Verschlüsselt: "+pMessage);
        System.out.println("User 1: "+this.decode(pMessage));
    }
    ...
    public String decode(String nachricht){
        ...
        while(!nachricht.isEmpty()){
            ...
            //Zuordnung der Zahl zu Buchstaben
    ...
    public void processClosingConnection(String pClientIP, int pClientPort){
        //Bestätigung vom Verbundungsverlust
